//*CID://+1Aj2R~: update#=  73;                                    //+1Aj2R~
//*********************************
//1Ai2 2016/12/29 Android 5 isssue WARNING "linker unused DT entry", ignore it//+1Aj2I~
...
import com.Ajagoc.URunnableData;
...
//import static com.Ajagoc.gtp.I18n.i18n;                        //~v1B6R~
...
//    }
                                                                   //~v1B6I~
    private static final String MSG_UNUSED_DT="unused DT entry";   //+1Aj2I~
	public static final String REG_GENMOVE="reg_genmove";  //for fuego//~1AfmR~
	private boolean reg_genmove;//for fuego                        //~1AfmI~
    private GTPConnector gtpconnector;                             //~v1B6I~
//    private GoColor computerColor;                               //~v1B6R~
...
//        throws GtpError, ErrorMessage
    public GoGui(Object owner,                                     //~v1B6R~
                 String program,            int move, String time, //~v1B6I~
...
//               File analyzeCommandsFile)                         //~1AfmR~
                 File analyzeCommandsFile,boolean Preg_genmove)    //~1AfmI~
//      throws GtpError, ErrorMessage                              //~v1B6R~
    {                                                              //~v1B6R~
        reg_genmove=Preg_genmove;                                  //~1AfmI~
      try                                                          //~v1B6I~
      {                                                            //~v1B6I~
        gtpconnector=(GTPConnector)owner;                          //~v1B6I~
//      int boardSize = m_prefs.getInt("boardsize", GoPoint.DEFAULT_SIZE);//~v1B6R~
...
//          m_analyzeCommandsFile = analyzeCommandsFile;           //~v1B6R~
//        m_move = move;
//        m_register = register;
...
//        }
//        if (computerWhite)                                       //~v1B6R~
//            computerColor=GoColor.WHITE;                         //~v1B6R~
//        else                                                     //~v1B6R~
//            computerColor=GoColor.BLACK;                         //~v1B6R~
//        m_auto = auto;                                           //~v1B6R~
...
//        m_game = new Game(boardSize);                            //~v1B6R~
...
//      m_timeSettings = gtpconnector.getTimeSettings(time);       //~v1B6R~
//        protectGui(); // Show wait cursor
//      SwingUtilities.invokeLater(new Runnable() {                //~v1B6R~
...
//                            {                                    //~v1B6R~
//                                GoGui gogui;                     //~v1B6R~
//                                gogui=(GoGui)Pany;               //~v1B6R~
//                                try                              //~v1B6R~
//                                {                                //~v1B6R~
//                                    initialize();                //~v1B6R~
//                                    gogui.gtpconnector.gotOk();  //~v1B6R~
//                                }                                //~v1B6R~
//                                catch(Exception e)               //~v1B6R~
//                                {                                //~v1B6R~
//                                    Dump.println(e,"GoGui initialize()");//~v1B6R~
//                                }                                //~v1B6R~
//                            }                                    //~v1B6R~
//                        },this/*Pany*/);                         //~v1B6R~
//                                                                 //~v1B6R~
//  	AjagoUiThread.invokeLater(new Runnable() {                 //~v1B6R~
		Runnable runinit=new Runnable() {                          //~v1B6I~
            ...
            new Thread(runinit).start();//@@@@test exe on subthread because boardsize cmd is lengthy if book option is on//~v1B6I~
      }                                                            //~v1B6I~
...
//        known. */
    ...
    {                                                              //~v1B6R~
        ...
        if (name == null)                                          //~v1B6R~
//          name = i18n("MSG_UNKNOWN_PROGRAM_NAME");               //~v1B6R~
...
//    }
    ...
    {                                                              //~v1B6I~
        ...
        {                                                          //~v1B6I~
        	...
        	AjagoAlert.simpleAlertDialog(null/*callback*/,R.string.DialogTitle_gtpconnection,mainMessage,flag);//~v1B6I~
        }                                                          //~v1B6I~
    }                                                              //~v1B6I~
...
//    private boolean m_beepAfterMove;
    ...
    private boolean m_computerBlack;                               //~v1B6R~

    private boolean m_computerWhite;                               //~v1B6R~

    /** State variable used between generateMove and computerMoved.//~v1B6R~
        Flag is set in actionInterrupt. */                         //~v1B6R~
//    private boolean m_interruptComputerBoth;                     //~v1B6R~

//    /** State variable used between generateMove and computerMoved. *///~v1B6R~
//    private boolean m_isSingleMove;                              //~v1B6R~
...
//    private final boolean m_verbose;                             //~v1B6R~
...
//  private GuiGtpClient m_gtp;                                    //~v1B6R~
...
//  private final File m_analyzeCommandsFile;                      //~v1B6R~
//    private File m_analyzeCommandsFile;                          //~v1B6R~
...
//  private final String m_gtpCommand;                             //~v1B6R~
    private String m_gtpCommand;                                   //~v1B6I~

//    private final String m_gtpFile;

//    private String m_lastAnalyzeCommand;                         //~v1B6R~

    private String m_programCommand;                               //~v1B6R~

//    private String m_titleFromProgram;

//  private String m_version = "";                                 //~v1B6R~
    public  String m_version = "";                                 //~v1B6I~
...
//    private ArrayList<AnalyzeDefinition> m_analyzeCommands;      //~v1B6R~
...
//  private TimeSettings m_timeSettings;                           //~v1B6R~
...
//  private boolean attachProgram(String programCommand, Program program,//~v1B6R~
//                                boolean register)                //~v1B6R~
...
//        if (m_shell != null)                                     //~v1B6R~
//        {                                                        //~v1B6R~
//            m_shell.dispose();                                   //~v1B6R~
//            m_shell = null;                                      //~v1B6R~
//        }                                                        //~v1B6R~
//        m_shell = new GtpShell(this, this, m_messageDialogs);    //~v1B6R~
//        GuiAction.registerAll(m_shell.getLayeredPane());         //~v1B6R~
//        m_shell.addWindowListener(new WindowAdapter() {          //~v1B6R~
//                public void windowClosing(WindowEvent e) {       //~v1B6R~
//                    saveSession();                               //~v1B6R~
//                    hideShell();                                 //~v1B6R~
//                }                                                //~v1B6R~
//            });                                                  //~v1B6R~
//        restoreSize(m_shell, "shell");                           //~v1B6R~
//        m_shell.setProgramCommand(programCommand);               //~v1B6R~
//        m_shell.setTimeStamp(m_timeStamp);                       //~v1B6R~
//        m_shell.setCommandCompletion(m_commandCompletion);       //~v1B6R~
        GtpClient.InvalidResponseCallback invalidResponseCallback =//~v1B6R~
            ...
            {                                                      //~v1B6R~
                ...
                {                                                  //~v1B6R~
//                    Runnable runnable = new ShowInvalidResponse(line);//~v1B6R~
//                    if (SwingUtilities.isEventDispatchThread())  //~v1B6R~
//                        runnable.run();                          //~v1B6R~
//                    else                                         //~v1B6R~
//                        GuiUtil.invokeAndWait(runnable);         //~v1B6R~
                    new ShowInvalidResponse(false,line);           //~v1B6I~
                    if (Dump.Y) Dump.println("GtpClient.InvalidResponseCallback:"+line);//~v1B6I~
                }                                                  //~v1B6R~
            };                                                     //~v1B6R~
...
//                    if (m_shell == null)                         //~v1B6R~
//                        return;                                  //~v1B6R~
//                    boolean invokeLater = true;                  //~v1B6R~
//                    m_shell.receivedInvalidResponse(s, invokeLater);//~v1B6R~
                    if (Dump.Y) Dump.println("GtpClient.IOCallback.receivedInvalidResponse:"+s);//~v1B6I~
...
//                        return;                                  //~v1B6R~
//                    boolean invokeLater = true;                  //~v1B6R~
//                    m_shell.receivedResponse(error, s, invokeLater);//~v1B6R~
                    if (Dump.Y) Dump.println("GoGui:receivedResponse="+s);//~v1C3R~
                ...
                {                                                  //~v1B6R~
                    if (Dump.Y) Dump.println("GoGui:receivedStdErr="+s);//~v1C3I~
//                    if (m_shell == null)                         //~v1B6R~
//                        return;                                  //~v1B6R~
...
//                        boolean isLiveGfx = m_liveGfx.handleLine(line);//~v1B6R~
                        boolean isWarning =                        //~v1B6R~
                            line.startsWith("warning:")            //~v1B6R~
                            || line.startsWith("Warning:")         //~v1B6R~
                            || line.startsWith("WARNING:");        //~v1B6R~
//                        boolean invokeLater = true;              //~v1B6R~
//                        m_shell.receivedStdErr(line, invokeLater, isLiveGfx,//~v1B6R~
//                                               isWarning);       //~v1B6R~
                    	if (Dump.Y) Dump.println("GtpClient.IOCallback.receivedStdErr:"+line);//~v1B6I~
                        if (isWarning)                             //~v1B6I~
                        {                                          //+1Aj2I~
                          if (line.indexOf(MSG_UNUSED_DT)<0)       //+1Aj2I~
...
//                    if (m_shell != null)                         //~v1B6R~
//                        m_shell.sentCommand(s);                  //~v1B6R~
                }                                                  //~v1B6R~

                private final LineReader m_lineReader = new LineReader();//~v1B6R~

//                private LiveGfx m_liveGfx = new LiveGfx(GoGui.this);//~v1B6R~
            };                                                     //~v1B6R~
...
//                    String text = "[" + moveNumber + "]";        //~v1B6R~
//                    m_statusBar.immediatelyPaintMoveText(text);  //~v1B6R~
                }                                                  //~v1B6R~
            };                                                     //~v1B6R~
        try                                                        //~v1B6R~
        {                                                          //~v1B6R~
//            showStatusImmediately(i18n("STAT_ATTACHING_PROGRAM"));//~v1B6R~
            File workingDirectory = null;                          //~v1B6R~
//            if (program != null                                  //~v1B6R~
//                && ! StringUtil.isEmpty(program.m_workingDirectory))//~v1B6R~
//                workingDirectory = new File(program.m_workingDirectory);//~v1B6R~
            ...
            m_gtp.queryName();                                     //~v1B6I~
            m_gtp.queryProtocolVersion();                          //~v1B6R~
            try                                                    //~v1B6R~
            {                                                      //~v1B6R~
                m_version = m_gtp.queryVersion();                  //~v1B6R~
//                m_shell.setProgramVersion(m_version);            //~v1B6R~
                m_gtp.querySupportedCommands();                    //~v1B6R~
                m_gtp.queryInterruptSupport();                     //~v1B6R~
//                if (m_program == null)                           //~v1B6R~
//                {                                                //~v1B6R~
//                    m_program =                                  //~v1B6R~
//                        Program.findProgram(m_programs, programCommand);//~v1B6R~
//                    if (m_program == null && m_register)         //~v1B6R~
//                    {                                            //~v1B6R~
//                        m_program = new Program("", m_gtp.getName(), m_version,//~v1B6R~
//                                                programCommand, "");//~v1B6R~
//                        m_program.setUniqueLabel(m_programs);    //~v1B6R~
//                        m_programs.add(m_program);               //~v1B6R~
//                        m_menuBar.setPrograms(m_programs);       //~v1B6R~
//                        Program.save(m_programs);                //~v1B6R~
//                    }                                            //~v1B6R~
//                }                                                //~v1B6R~
            }                                                      //~v1B6R~
            catch (GtpError e)                                     //~v1B6R~
            {                                                      //~v1B6R~
                Dump.println(e,"attachProgram");                   //~v1B6I~
            }                                                      //~v1B6R~
//            if (m_program != null                                //~v1B6R~
//                && m_program.updateInfo(getProgramName(), m_version))//~v1B6R~
//            {                                                    //~v1B6R~
//                Program.save(m_programs);                        //~v1B6R~
//                m_menuBar.setPrograms(m_programs);               //~v1B6R~
//            }                                                    //~v1B6R~
//            try                                                  //~v1B6R~
//            {                                                    //~v1B6R~
//                String programAnalyzeCommands                    //~v1B6R~
//                    = GtpClientUtil.getAnalyzeCommands(m_gtp);   //~v1B6R~
//                m_analyzeCommands                                //~v1B6R~
//                    = AnalyzeDefinition.read(m_gtp.getSupportedCommands(),//~v1B6R~
//                                             m_analyzeCommandsFile,//~v1B6R~
//                                             programAnalyzeCommands);//~v1B6R~
//            }                                                    //~v1B6R~
//            catch (ErrorMessage e)                               //~v1B6R~
//            {                                                    //~v1B6R~
////              showError(i18n("MSG_COULD_NOT_READ_ANALYZE_CONFIGURATION"), e);//~v1B6R~
//                showError(Rstr(R.string.GtpFmt_MSG_COULD_NOT_READ_ANALYZE_CONFIGURATION), e);//~v1B6R~
//            }                                                    //~v1B6R~
//            restoreSize(m_shell, "shell");                       //~v1B6R~
//            m_shell.setProgramName(getProgramLabel());           //~v1B6R~
//            ArrayList<String> supportedCommands =                //~v1B6R~
                m_gtp.getSupportedCommands();                      //~v1B6R~
//            m_shell.setInitialCompletions(supportedCommands);    //~v1B6R~
            if (reg_genmove)                                       //~1AfmI~
				if (!m_gtp.isSupported(REG_GENMOVE))               //~1AfmI~
            		reg_genmove=false;                             //~1AfmI~
           if (!reg_genmove)                                       //~1AfmI~
            if (! m_gtp.isGenmoveSupported())                      //~v1B6R~
            {                                                      //~v1B6R~
                m_computerBlack = false;                           //~v1B6R~
                m_computerWhite = false;                           //~v1B6R~
            }                                                      //~v1B6R~
            initGtp();                                             //~v1B6R~
//            if (! m_gtpFile.equals(""))                          //~v1B6R~
//                sendGtpFile(new File(m_gtpFile));                //~v1B6R~
...
//        setVisible(false);
//        SwingUtilities.invokeLater(new Runnable() {
        AjagoUiThread.invokeLater(new Runnable() {                 //~v1B6I~
                public void run() {                                //~v1B6R~
...
//                  System.exit(0);                                //~v1B6R~
    ...
    private void computerMoved()                                   //~v1B6R~
    {                                                              //~v1B6R~
        if (! endLengthyCommand())                                 //~v1B6R~
            return;                                                //~v1B6R~
//        if (m_beepAfterMove)                                     //~v1B6R~
//            Toolkit.getDefaultToolkit().beep();                  //~v1B6R~
		if (m_gtp==null) 	//after detached                       //~v1B6I~
        	return;                                                //~v1B6I~
        GoPoint point=null;                                        //~v1B6I~
//        GoColor toMove = getToMove();                            //~v1B6R~
        try                                                        //~v1B6R~
        {                                                          //~v1B6R~
            String response = m_gtp.getResponse();                 //~v1B6R~
//            checkLostOnTime(toMove);                             //~v1B6R~
//            boolean gameTreeChanged = false;                     //~v1B6R~
//            String name = getProgramName();                      //~v1B6R~
            if (response==null)                                    //~v1B6I~
		        throw new GtpResponseFormatError("computerMoved:null response");//~v1B6R~
            if (response.equalsIgnoreCase("resign"))               //~v1B6R~
            {                                                      //~v1B6R~
//                String result =                                  //~v1B6R~
//                    toMove.otherColor().getUppercaseLetter() + "+Resign";//~v1B6R~
//                if (! m_auto)                                    //~v1B6R~
//                {                                                //~v1B6R~
//                    String mainMessage = format(i18n("MSG_RESIGN"), name);//~v1B6R~
//                    String optionalMessage =                     //~v1B6R~
//                        format(i18n("MSG_RESIGN_2"), result);    //~v1B6R~
//                    showInfo(mainMessage, optionalMessage, false);//~v1B6R~
//                }                                                  //~v1B6R~
                m_resigned = true;                                 //~v1B6R~
//                setResult(result);                               //~v1B6R~
            }                                                      //~v1B6R~
            else                                                   //~v1B6R~
            {                                                      //~v1B6R~
//              GoPoint point = GtpUtil.parsePoint(response, getBoardSize());//~v1B6R~
                point = GtpUtil.parsePoint(response,boardSize);    //~v1B6R~
//                ConstBoard board = getBoard();                   //~v1B6R~
//                if (point != null)                               //~v1B6R~
//                {                                                //~v1B6R~
//                    if (board.getColor(point) != EMPTY)          //~v1B6R~
//                    {                                            //~v1B6R~
//                        String mainMessage =                     //~v1B6R~
//                            format(i18n("MSG_NONEMPTY"), name);  //~v1B6R~
//                        String optionalMessage =                 //~v1B6R~
//                            format(i18n("MSG_NONEMPTY_2"), name);//~v1B6R~
//                        showWarning(mainMessage, optionalMessage, true);//~v1B6R~
//                        m_computerBlack = false;                 //~v1B6R~
//                        m_computerWhite = false;                 //~v1B6R~
//                    }                                            //~v1B6R~
//                    else if (board.isKo(point))                  //~v1B6R~
//                    {                                            //~v1B6R~
//                        String mainMessage =                     //~v1B6R~
//                            format(i18n("MSG_VIOLATE_KO"), name);//~v1B6R~
//                        showWarning(mainMessage, i18n("MSG_VIOLATE_KO_2"),//~v1B6R~
//                                    true);                       //~v1B6R~
//                        m_computerBlack = false;                 //~v1B6R~
//                        m_computerWhite = false;                 //~v1B6R~
//                    }                                            //~v1B6R~
//                }                                                //~v1B6R~
//                Move move = Move.get(toMove, point);             //~v1B6R~
//                m_game.play(move);                               //~v1B6R~
//                m_gtp.updateAfterGenmove(getBoard());            //~v1B6R~
                if (point == null && ! isComputerBoth())           //~v1B6R~
                {                                                  //~v1B6R~
//                    String disableKey =                          //~v1B6R~
//                        "net.sf.gogui.gogui.GoGui.computer-passed";//~v1B6R~
//                    String mainMessage =                         //~v1B6R~
//                        format(i18n("MSG_PROGRAM_PASS"), name);  //~v1B6R~
//                    String optionalMessage =                     //~v1B6R~
//                        format(i18n("MSG_PROGRAM_PASS_2"), name);//~v1B6R~
//                    m_messageDialogs.showInfo(disableKey, this, mainMessage,//~v1B6R~
//                                              optionalMessage, false);//~v1B6R~
                }                                                  //~v1B6R~
                m_resigned = false;                                //~v1B6R~
//                gameTreeChanged = true;                          //~v1B6R~
//                ConstNode currentNode = getCurrentNode();        //~v1B6R~
//                if (currentNode.getFatherConst().getNumberChildren() == 1)//~v1B6R~
//                {                                                //~v1B6R~
//                    if (m_gameTreeViewer != null)                //~v1B6R~
//                        m_gameTreeViewer.addNewSingleChild(currentNode);//~v1B6R~
//                    gameTreeChanged = false;                     //~v1B6R~
//                }                                                //~v1B6R~
            }                                                      //~v1B6R~
//            boolean doCheckComputerMove                          //~v1B6R~
//                = (! m_isSingleMove                              //~v1B6R~
//                   && ! (isComputerBoth() && m_interruptComputerBoth));//~v1B6R~
//            boardChangedBegin(doCheckComputerMove, gameTreeChanged);//~v1B6R~
			gtpconnector.gotMoved(point,m_resigned);                //~v1B6R~
        }                                                          //~v1B6R~
        catch (GtpResponseFormatError e)                           //~v1B6R~
        {                                                          //~v1B6R~
            showError(e);                                          //~v1B6R~
//            clearStatus();                                       //~v1B6R~
        }                                                          //~v1B6R~
...
//    }
    ...
    {                                                              //~v1B6R~
//        if (m_gtp != null)                                       //~v1B6R~
//            showStatusImmediately(i18n("STAT_DETACHING"));       //~v1B6R~
        ...
        m_gtp = null;                                              //~v1B6R~
//        if (m_analyzeCommand != null)                            //~v1B6R~
//            clearAnalyzeCommand();                               //~v1B6R~
//        m_version = null;                                        //~v1B6R~
//        m_shell.dispose();                                       //~v1B6R~
//        m_shell = null;                                          //~v1B6R~
//        if (m_analyzeDialog != null)                             //~v1B6R~
//        {                                                        //~v1B6R~
//            m_analyzeDialog.saveRecent();                        //~v1B6R~
//            m_analyzeDialog.dispose();                           //~v1B6R~
//            m_analyzeDialog = null;                              //~v1B6R~
//        }                                                        //~v1B6R~
//        resetBoard();                                            //~v1B6R~
//        clearStatus();                                           //~v1B6R~
//        setTitle();                                              //~v1B6R~
...
//    private void generateMove(boolean isSingleMove)              //~v1B6R~
//    {                                                            //~v1B6R~
//        if (! synchronizeProgram())                              //~v1B6R~
//            return;                                              //~v1B6R~
//        GoColor toMove = getToMove();                            //~v1B6R~
//        ConstNode node = getCurrentNode();                       //~v1B6R~
//        ConstNode father = node.getFatherConst();                //~v1B6R~
//        ConstGameInfo info = getGameInfo();                      //~v1B6R~
//        String playerToMove = info.get(StringInfoColor.NAME, toMove);//~v1B6R~
//        String playerOther =                                     //~v1B6R~
//            info.get(StringInfoColor.NAME, toMove.otherColor()); //~v1B6R~
//        String name = getProgramLabel();                         //~v1B6R~
//        if (! isSingleMove && m_gameFile == null && playerToMove == null//~v1B6R~
//            && (father == null                                   //~v1B6R~
//                || (! father.hasFather()                         //~v1B6R~
//                    && (playerOther == null || playerOther.equals(name)))))//~v1B6R~
//        {                                                        //~v1B6R~
//            m_game.setPlayer(toMove, name);                      //~v1B6R~
//            updateViews(false);                                  //~v1B6R~
//        }                                                        //~v1B6R~
//        String command;                                          //~v1B6R~
//        if (NodeUtil.isInCleanup(getCurrentNode())               //~v1B6R~
//            && m_gtp.isSupported("kgs-genmove_cleanup"))         //~v1B6R~
//        {                                                        //~v1B6R~
//            command = "kgs-genmove_cleanup";                     //~v1B6R~
//            if (toMove == BLACK)                                 //~v1B6R~
//                command += " b";                                 //~v1B6R~
//            else if (toMove == WHITE)                            //~v1B6R~
//                command += " w";                                 //~v1B6R~
//            else                                                 //~v1B6R~
//                assert false;                                    //~v1B6R~
//        }                                                        //~v1B6R~
//        else                                                     //~v1B6R~
//        {                                                        //~v1B6R~
//            command = m_gtp.getCommandGenmove(toMove);           //~v1B6R~
//        }                                                        //~v1B6R~
//        m_isSingleMove = isSingleMove;                           //~v1B6R~
//        m_interruptComputerBoth = false;                         //~v1B6R~
//        Runnable callback = new Runnable()                       //~v1B6R~
//            {                                                    //~v1B6R~
//                public void run()                                //~v1B6R~
//                {                                                //~v1B6R~
//                    computerMoved();                             //~v1B6R~
//                }                                                //~v1B6R~
//            };                                                   //~v1B6R~
//        if (getClock().isInitialized()                           //~v1B6R~
//            && NodeUtil.isTimeLeftKnown(getCurrentNode(), toMove))//~v1B6R~
//            GtpUtil.sendTimeLeft(m_gtp, getClock(), toMove);     //~v1B6R~
//        m_game.startClock();                                     //~v1B6R~
//        runLengthyCommand(command, callback);                    //~v1B6R~
//    }                                                            //~v1B6R~
    public void generateMove(boolean isSingleMove,GoColor Phumancolor)//~v1B6R~
    {                                                              //~v1B6I~
//        if (! synchronizeProgram())                              //~v1B6I~
//            return;                                              //~v1B6I~
//        GoColor toMove = getToMove();                            //~v1B6I~
//        ConstNode node = getCurrentNode();                       //~v1B6I~
//        ConstNode father = node.getFatherConst();                //~v1B6I~
//        ConstGameInfo info = getGameInfo();                      //~v1B6I~
//        String playerToMove = info.get(StringInfoColor.NAME, toMove);//~v1B6I~
//        String playerOther =                                     //~v1B6I~
//            info.get(StringInfoColor.NAME, toMove.otherColor()); //~v1B6I~
//        String name = getProgramLabel();                         //~v1B6I~
//        if (! isSingleMove && m_gameFile == null && playerToMove == null//~v1B6I~
//            && (father == null                                   //~v1B6I~
//                || (! father.hasFather()                         //~v1B6I~
//                    && (playerOther == null || playerOther.equals(name)))))//~v1B6I~
//        {                                                        //~v1B6I~
//            m_game.setPlayer(toMove, name);                      //~v1B6I~
//            updateViews(false);                                  //~v1B6I~
//        }                                                        //~v1B6I~
        GoColor toMove = Phumancolor.otherColor();;                //~v1B6I~
        String command;                                            //~v1B6I~
//        if (NodeUtil.isInCleanup(getCurrentNode())               //~v1B6I~
//            && m_gtp.isSupported("kgs-genmove_cleanup"))         //~v1B6I~
//        {                                                        //~v1B6I~
//            command = "kgs-genmove_cleanup";                     //~v1B6I~
//            if (toMove == BLACK)                                 //~v1B6I~
//                command += " b";                                 //~v1B6I~
//            else if (toMove == WHITE)                            //~v1B6I~
//                command += " w";                                 //~v1B6I~
//            else                                                 //~v1B6I~
//                assert false;                                    //~v1B6I~
//        }                                                        //~v1B6I~
//        else                                                     //~v1B6I~
//        {                                                        //~v1B6I~
//          command = m_gtp.getCommandGenmove(toMove);             //~1AfmI~
            command = m_gtp.getCommandGenmove(toMove,reg_genmove?REG_GENMOVE:null);//~1AfmR~
//        }                                                        //~v1B6I~
//        m_isSingleMove = isSingleMove;                           //~v1B6R~
//        m_interruptComputerBoth = false;                         //~v1B6R~
        Runnable callback = new Runnable()                         //~v1B6I~
            {                                                      //~v1B6I~
                public void run()                                  //~v1B6I~
                {                                                  //~v1B6I~
                	try                                            //~v1B6I~
                    ...
                    {                                              //~v1B6I~
						Dump.println(e,"computerMoved");           //~v1B6I~
                    }                                              //~v1B6I~
                }                                                  //~v1B6I~
            };                                                     //~v1B6I~
//        if (getClock().isInitialized()                           //~v1B6I~
//            && NodeUtil.isTimeLeftKnown(getCurrentNode(), toMove))//~v1B6I~
//            GtpUtil.sendTimeLeft(m_gtp, getClock(), toMove);     //~v1B6I~
//        m_game.startClock();                                     //~v1B6I~
        runLengthyCommand(command, callback);                      //~v1B6I~
    }                                                              //~v1B6I~
...
//    private ConstGameInfo getGameInfo()                          //~v1B6R~
//    {                                                            //~v1B6R~
//        return m_game.getGameInfo(getCurrentNode());             //~v1B6R~
//    }                                                            //~v1B6R~
...
//    private GoColor getToMove()                                  //~v1B6R~
//    {                                                            //~v1B6R~
////        return m_game.getToMove();                             //~v1B6R~
//        return computerColor;                                    //~v1B6R~
//    }                                                            //~v1B6R~
...
//    }
    ...
    {                                                              //~v1B6R~
        ...
        {                                                          //~v1B6R~
            ...
            {                                                      //~v1B6R~
//                ConstGameInfo info = getGameInfo();              //~v1B6R~
//              m_gtp.initSynchronize(getBoard(), info.getKomi(),  //~v1B6R~
//                                    info.getTimeSettings());     //~v1B6R~
                m_gtp.initSynchronize(gtpconnector.getBoardSize(),gtpconnector.getKomi(),m_timeSettings);//~v1B6R~
            }                                                      //~v1B6R~
...
//                m_prefs.putInt("program", -1);
//        }
        if (m_programCommand != null)                              //~v1B6I~
        {                                                          //~v1B6I~
//          attachProgram(m_programCommand, m_program);            //~v1B6R~
            attachProgram(m_programCommand);                       //~v1B6I~
//            if (m_gtp == null || m_gtp.isProgramDead())          //~v1B6R~
//                m_prefs.putInt("program", -1);                   //~v1B6R~
        }                                                          //~v1B6I~
//        setTitle();
        ...
        {                                                          //~v1B6R~
            ...
            {                                                      //~v1B6R~
                ...
                {                                                  //~v1B6R~
                    ...
                    {                                              //~v1B6R~
//                      showError(i18n("MSG_BOARD_CHANGING_COMMAND"), "");//~v1B6R~
                    ...
                    {                                              //~v1B6R~
                        showError(e);                              //~v1B6R~
//                        if (m_gtp.isProgramDead()                //~v1B6R~
//                            || ! showQuestion(i18n("MSG_CONTINUE_SEND"), "",//~v1B6R~
//                                              i18n("LB_CONTINUE_SEND"), false))//~v1B6R~
//                            break;                               //~v1B6R~
                    }                                              //~v1B6R~
                }                                                  //~v1B6R~
                catch (IOException e)                              //~v1B6R~
                {                                                  //~v1B6R~
//                  showError(i18n("MSG_COULD_NOT_READ_FILE"), e); //~v1B6R~
...
//  private void sendGtpString(String commands)                    //~v1B6R~//~v1C1R~
...
//    }
    ...
    {                                                              //~v1B6R~
        String name = getProgramName();                            //~v1B6R~
//      String mainMessage = format(i18n("MSG_INVALID_RESPONSE"), name);//~v1B6R~
        String mainMessage = format(Rstr(R.string.GtpFmt_MSG_INVALID_RESPONSE), name);//~v1B6I~
        String optionalMessage =                                   //~v1B6R~
//            format(i18n("MSG_INVALID_RESPONSE_2"), name, e.getMessage());//~v1B6R~
...
//              mainMessage = format(i18n("MSG_PROGRAM_TERMINATED"), name);//~v1B6R~
                mainMessage = format(Rstr(R.string.GtpFmt_MSG_PROGRAM_TERMINATED), name);//~v1B6I~
            else                                                   //~v1B6R~
//              mainMessage = i18n("MSG_PROGRAM_TERMINATED_UNEXPECTEDLY");//~v1B6R~
                mainMessage = Rstr(R.string.GtpFmt_MSG_PROGRAM_TERMINATED_UNEXPECTEDLY);//~v1B6R~
//          boolean hasErrorOutput = m_shell.isLastTextNonGTP();   //~v1B6R~
//            boolean hasErrorOutput = false;                      //~v1B6R~
//            boolean anyResponses = m_gtp.getAnyCommandsResponded();//~v1B6R~
//            if (hasErrorOutput && ! anyResponses)                //~v1B6R~
//                optionalMessage =                                //~v1B6R~
////                  format(i18n("MSG_PROGRAM_TERMINATED_2"), name);//~v1B6R~
//                    format(Rstr(R.string.GtpFmt_MSG_PROGRAM_TERMINATED_2), name);//~v1B6R~
//            else if (hasErrorOutput && anyResponses)             //~v1B6R~
//                optionalMessage =                                //~v1B6R~
////                  format(i18n("MSG_PROGRAM_TERMINATED_3"), name);//~v1B6R~
//                    format(Rstr(R.string.GtpFmt_MSG_PROGRAM_TERMINATED_3), name);//~v1B6R~
//            else                                                 //~v1B6R~
//              optionalMessage = i18n("MSG_PROGRAM_TERMINATED_4");//~v1B6R~
//                optionalMessage = Rstr(R.string.GtpFmt_MSG_PROGRAM_TERMINATED_4);//~v1B6R~
//            optionalMessage ="";                                 //~v1B6I~//~v1C3R~
              optionalMessage =errInStdErr;                        //~v1C3I~
        }                                                          //~v1B6R~
        else if (e instanceof GtpClient.ExecFailed)                //~v1B6R~
        {                                                          //~v1B6R~
//          mainMessage = i18n("MSG_COULD_NOT_EXECUTE");           //~v1B6R~
            mainMessage = Rstr(R.string.GtpFmt_MSG_COULD_NOT_EXECUTE);//~v1B6I~
            if (StringUtil.isEmpty(e.getMessage()))                //~v1B6R~
//              optionalMessage = i18n("MSG_COULD_NOT_EXECUTE_2"); //~v1B6R~
                optionalMessage = Rstr(R.string.GtpFmt_MSG_COULD_NOT_EXECUTE_2);//~v1B6I~
            else                                                   //~v1B6R~
                optionalMessage =                                  //~v1B6R~
//                  format(i18n("MSG_COULD_NOT_EXECUTE_3"), e.getMessage());//~v1B6R~
                    format(Rstr(R.string.GtpFmt_MSG_COULD_NOT_EXECUTE_3), e.getMessage());//~v1B6I~
        }                                                          //~v1B6R~
        else                                                       //~v1B6R~
        {                                                          //~v1B6R~
//          mainMessage = i18n("MSG_COMMAND_FAILED");              //~v1B6R~
            mainMessage = Rstr(R.string.GtpFmt_MSG_COMMAND_FAILED);//~v1B6I~
            if (e.getMessage().trim().equals(""))                  //~v1B6R~
                optionalMessage =                                  //~v1B6R~
//                  format(i18n("MSG_COMMAND_FAILED_2"), e.getCommand());//~v1B6R~
                    format(Rstr(R.string.GtpFmt_MSG_COMMAND_FAILED_2), e.getCommand());//~v1B6I~
            else                                                   //~v1B6R~
                optionalMessage =                                  //~v1B6R~
//                  format(i18n("MSG_COMMAND_FAILED_3"), e.getCommand(),//~v1B6R~
...
//        updateViews(false); // If program died, menu items need to be updated//~v1B6R~
    }                                                              //~v1B6R~
...
//    private boolean showQuestion(String mainMessage, String optionalMessage,//~v1B6R~
//                                 String destructiveOption, boolean isCritical)//~v1B6R~
//    {                                                            //~v1B6R~
//        return m_messageDialogs.showQuestion(this, mainMessage,  //~v1B6R~
//                                             optionalMessage,    //~v1B6R~
...
//    }
    ...
    {                                                              //~v1C3I~
    	AjagoView.showToastLong(R.string.GtpErr_ErrInStdErr,"\n"+Pline);//~v1C3I~
        errInStdErr+=Pline;                                        //~v1C3I~
    }                                                              //~v1C3I~
	//*************************************************************************//~1AfgI~
    private URunnableData progressDialog;                          //~1AfgI~
    private void waitingMsg(int Paction)                           //~1AfgI~
    {                                                              //~1AfgI~
        ...
        {                                                          //~1AfgI~
    		...
    		dismissProgressDialog(progressDialog);                 //~1AfgI~
    }                                                              //~1AfgI~
