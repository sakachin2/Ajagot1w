...
//*move up element                                                 //~1Af9I~
	public void moveUp (ListElement l)                             //~1Af9I~
	{                                                              //~1Af9I~
    	if (l==null)                                               //~1Af9I~
        	return;                                                //~1Af9I~
		ListElement prev=l.previous();                             //+1Af9R~
        if (prev==null)                                            //~1Af9I~
        	return;                                                //~1Af9I~
		ListElement after=prev.previous();                         //+1Af9R~
		remove(l);                                                 //~1Af9I~
		insert(l,after);                                           //~1Af9I~
	}                                                              //~1Af9I~
//*move down element                                               //~1Af9I~
	public void moveDown (ListElement l)                           //~1Af9I~
	{                                                              //~1Af9I~
    	if (l==null)                                               //~1Af9I~
        	return;                                                //~1Af9I~
		ListElement after=l.next();                                //+1Af9R~
        if (after==null)                                           //~1Af9I~
        	return;                                                //~1Af9I~
		remove(l);                                                 //~1Af9I~
		insert(l,after);                                           //~1Af9I~
