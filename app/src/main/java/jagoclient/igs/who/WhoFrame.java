...
//import java.awt.MenuItem;                                        //~1417R~
//import java.awt.Panel;                                           //~1417R~
//import java.awt.PopupMenu;                                       //~1417R~
...
{	IgsStream In;
	...
	*/
//  synchronized public boolean close ()                           //+v108R~
//  {	if (GD!=null) GD.unchain();                                //+v108I~
    ...
    {                                                              //+v108I~
      ...
      {                                                            //+v108I~
        AjagoView.lockContention("Who-close");                     //+v108I~
        return false;                                              //+v108I~
      }                                                            //+v108I~
	}
	...
	frame.
	*/
//  synchronized public void refresh ()                            //+v108R~
//  {	L=new ListClass();                                         //+v108R~
    ...
    {                                                              //+v108I~
      ...
      {                                                            //+v108I~
        AjagoView.lockContention("Who-refresh");                   //+v108I~
      }                                                            //+v108I~
	}
	...
	display.
	*/
//	synchronized void allsended ()                                 //+v108R~
//	{	if (GD!=null) GD.unchain();                                //+v108R~
  	void allsended ()                                              //+v108I~
  	{                                                              //+v108I~
      if (lock.tryLock())                                          //+v108I~
      {                                                            //+v108I~
       try                                                         //+v108I~
      ...
      {                                                            //+v108I~
        AjagoView.lockContention("Who-allsend");                   //+v108I~
      }                                                            //+v108I~
	}

	/** receive a single line of players (two players) */
//	synchronized void receive (String s)                           //+v108R~
//	{	if (Closed) return;                                        //+v108R~
    void receive (String s)                                        //+v108I~
	{                                                              //+v108I~
      if (lock.tryLock())                                          //+v108I~
      {                                                            //+v108I~
       try                                                         //+v108I~
      ...
      {                                                            //+v108I~
        AjagoView.lockContention("Who-receive");                                //+v108I~
      }                                                            //+v108I~
	}
