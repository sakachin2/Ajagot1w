//*CID://+1A72R~:                                   update#=   10; //~1A72R~
//*******************************************************************//~@@@1I~
//2015/07/24 //1Ad2 2015/07/17 HelpDialog by helptext              //+1A72I~
...
//import java.awt.Color;                                           //~1109R~
//import android.app.Dialog;                                       //~1216R~
//import android.view.Window;

import com.Ajagoc.AG;
import com.Ajagoc.awt.Color;                                           //~1109I~
...
import com.Ajagoc.awt.Dialog;                                      //~1216I~
import com.Ajagoc.awt.KeyEvent;
import com.Ajagoc.java.FileInputStream;                            //~1327I~
//import java.awt.Component;                                       //~1417R~
//import java.awt.Dialog;                                          //~1417R~
//import java.awt.Dimension;                                       //~1417R~
//import java.awt.Font;                                            //~1109R~
import com.Ajagoc.awt.Font;                                            //~1109I~
//import java.awt.Frame;                                           //~1417R~
//import java.awt.Image;                                           //~1417R~
//import java.awt.Window;                                          //~1417R~
//import java.awt.event.KeyEvent;
                                                             //~1109I~
import java.io.BufferedReader;
import java.io.File;
//import java.io.FileInputStream;                                  //~1327R~
import java.io.FileNotFoundException;
import java.io.InputStream;
import java.io.InputStreamReader;
import java.io.UnsupportedEncodingException;
import java.net.URL;
//import java.util.Hashtable;                                      //~@@@1R~
...
public class Global extends com.Ajagoc.rene.gui.Global //@@@@ intercept Property file IO//~1308I~
...
//  public static Hashtable WindowList;                            //~@@@1R~
	...
	*/
	...
	{	try
		...
		catch (FileNotFoundException e)                            //~v1C7I~
		{                                                          //~v1C7I~
		 	Object G=new GlobalObject();                           //~v1C7I~
		  if (AG.tryHelpFileOpen)                                     //~1A41I~//+1A72I~
	        Dump.println("@@@@ Global:getDataStream Test help file existance failed for "+filename);//~1A41I~//+1A72I~
          else                                                     //~1A41I~//+1A72I~
    		if (AG.chkUpdateHelp)                                  //~v1C7I~
	        	Dump.println("@@@@ Global:getDataStream Test help file existance failed for "+filename);//~v1C7R~
            else                                                   //~v1C7I~
	        	Dump.println(e,"Global:getDataStream"+filename);   //~v1C7I~
			return G.getClass().getResourceAsStream("/"+filename); //~v1C7I~
		}                                                          //~v1C7I~
		catch (Exception e)
	...
	*/
	...
	{   SansSerif=createfont("sansserif","SansSerif","ssfontsize",11);
      ...
      if (AG.screenDencityMdpi)                                    //~v1D4I~
	    BigMonospaced=createfont("bigmonospaced","BoldMonospaced","bigmsfontsizemdpi",12);//~v1D4I~
      else                                                         //~v1D4I~
	...
	public static Font createfont (String name, String style, int Psize)//~@@@1R~//~1A72I~
	{                                                              //~@@@1I~//~1A72I~
	    if (name.equals("Bold"))                                   //~@@@1I~//~1A72I~
	    {   return new Font(style,Font.BOLD,Psize);                //~@@@1I~//~1A72I~
	    }                                                          //~@@@1I~//~1A72I~
	    else if (name.equals("Italic"))                            //~@@@1I~//~1A72I~
	    {   return new Font(style,Font.ITALIC,Psize);              //~@@@1I~//~1A72I~
	    }                                                          //~@@@1I~//~1A72I~
	    else                                                       //~@@@1I~//~1A72I~
	    {   return new Font(style,Font.PLAIN,Psize);               //~@@@1I~//~1A72I~
	    }                                                          //~@@@1I~//~1A72I~
	}                                                              //~@@@1I~//~1A72I~
	...
	*/
	public static void setwindow (Window c, String name, int w, int h,
		boolean minsize)
	{	int x=getParameter(name+"xpos",100),y=getParameter(name+"ypos",100);//~@@@1R~
	...
	*/
	...
	{	Dimension d=c.getToolkit().getScreenSize();                //~@@@1R~
	...
	*/
	...
	{	int x=f.getLocation().x+f.getSize().width/2-c.getSize().width/2,//~@@@1R~
			y=f.getLocation().y+f.getSize().height/2-c.getSize().height/2;
		w=getParameter(name+"width",w); h=getParameter(name+"height",h);
		Dimension d=c.getToolkit().getScreenSize();
		if (w>d.width) w=d.width;
	...
	public static void setpacked (Dialog c, String name, int w, int h)//~1113I~
	{                                                              //~1113I~
	}                                                              //~1113I~
