//*CID://+v1C9R~:                                   update#=   14; //+v1C9R~
//****************************************************************************//~@@@1I~
//v1C9 2014/09/03 change AjagocMenu to Dialog                      //+v1C9I~
//1B32 2013/07/01 one touch mode also on board menue               //~1B32I~
//1B0d 130429 change background of AllComment(Kibitz window) to distingush with Comment(swap as cardlayout)//~1B0dI~
...
import com.Ajagoc.awt.CardLayout;
...
import com.Ajagoc.awt.MenuBar;                                     //~1124I~
...
import jagoclient.gui.MyTextArea;                                                           //~1116I~//~1117M~
...
{	protected boolean TimerInTitle,ExtraSendField,BigTimer;
    ...
    private static final Color BG_ALLCOMMENTS=new Color(155,251,241);//light blue//~1B0dR~
    private static final Color BG_COMMENT=new Color(217,249,157);//light yellow//~1B0dI~
	/**
	...
	*/
	...
	{	super(s);
		...
		*/
		...
		M.add(score);
		score.add(new MenuItemAction(this,Global.resourceString("Resign")));//~@@@1I~
...
//  	AjagoMenu.addOneTouchModeMenuitem(this,options);           //~1B32I~//+v1C9R~
		...
		M.setHelpMenu(help);
		// Board
		L=new MyLabel(Global.resourceString("New_Game"));          //~1118R~
		Lm=new MyLabel("--");                                      //~1118R~
		...
		{	AllComments=new MyTextArea("",0,0,TextArea.SCROLLBARS_VERTICAL_ONLY);
			...
			AllComments.setBackground(BG_ALLCOMMENTS);             //~1B0dI~
...
//  	Comment.setBackground(Global.gray);                        //~1B0dR~
    	Comment.setBackground(BG_COMMENT);                         //~1B0dI~
